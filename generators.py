...
class NaiveGenerator:
    def __init__(self, pokemon, team_no=[], size=6, weights=None, utypes=False, uteam=False):
        self.pokemon = pokemon
        self.team_no = team_no
        self.size = size
        self.utypes = utypes
    ...
    def _generate_team_types(self, weaknesses, types, team=[]):
        ...
        for i in range(split, self.size):
            ...
            while (t in team_types and self.utypes) or (not uteam_exists and self.uteam):
